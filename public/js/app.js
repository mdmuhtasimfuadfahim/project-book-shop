...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/customer-orders', {
    headers: {
  ...
  function renderMenus(books) {
    var parsedMenus = Object.values(books);
    return parsedMenus.map(function (bookItem) {
      return "\n              <p>".concat(bookItem.books.bookName, " - ").concat(bookItem.bookqty, "  </p>\n            ");
    }).join('');
  }
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var stripe, elements, card, mountWidget, paymentType, paymentForm;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkProject_Book_Shop"] = self["webpackChunkProject_Book_Shop"] || [];
